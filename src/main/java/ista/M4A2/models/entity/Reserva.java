...
public class Reserva implements java.io.Serializable {
    ...
    // NUEVA RELACIÓN con Cubiculos
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "id_cubiculo")
    @JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
    private Cubiculos cubiculo;
    ...
    public Cubiculos getCubiculo() { return cubiculo; }
    public void setCubiculo(Cubiculos cubiculo) { this.cubiculo = cubiculo; }
}